...
# print(os.listdir("input")) #cek file input
...
class training:
    def __init__(self, ratings, movie):
        csvfile = open('input/ratings.csv','rb')
        csvfileM = open('input/movie.csv','rb')    
        self.ratings = csv.render(csvfile)

        self.movie = csv.render(csvfileM)
    ...
    def create_item_dict(self, df, id_col, name_col):
        '''
    ...
    def runMF(self, interactions, n_components=30, loss='warp', k=15, epoch=30,n_jobs = 4):
        '''
    ...
    def sample_recommendation_user(self, model, interactions, user_id, user_dict, 
